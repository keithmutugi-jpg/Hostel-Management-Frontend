  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.access_token) {
        // Store JWT in context securely
        login(data.access_token);

        // Redirect seamlessly to dashboard
        // Note: Your dashboard component will now handle displaying the custom Student features we wired up!
        navigate("/dashboard");
      } else {
      ...
      alert("Server not reachable. Please ensure Keith's backend is running.");
    }
